<template>
    <div class="warpper">
        <el-form :model="form2" ref="queryForm" size="small" :inline="true">
            <el-form-item label="训练时间" prop="brandName">
                <div class="selectBox">
                    <el-date-picker
                        v-model="form2.alarmTime"
                        type="date"
                        placeholder="请选择"
                        size="default"
                    />
            ...
            <el-form-item label="备注内容" prop="deviceAddress">
                <div class="selectBox">
                    <el-input v-model="form2.landType" placeholder="请输入" clearable style="width:250px"></el-input>
                </div>
            </el-form-item>
            <el-form-item label="模型状态" prop="deviceAddress">
                <div class="selectBox">
                    <el-select v-model="form2.status" placeholder="请选择" clearable style="width:250px">
                        <el-option style="background: #052243F5;color:#fff"  v-for="dict in statusOpiotns" :key="dict.value" :label="dict.label"
                            :value="dict.value" />
                    </el-select>
                </div>
            </el-form-item>
        ...
        <div class="tableWrapper">
            <el-table ref="reportTable" height="100%" class="table-with-header-bg" :data="landList" stripe
                ...
                <el-table-column label="模型名称" prop="brandName" :show-overflow-tooltip="true" width="150">
                    <template #default="scope">
                        <span>{{ scope.row.brandName == 'DH' ? '测试模型' : '测试模型' }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="收藏状态" prop="brandName" :show-overflow-tooltip="true" width="150">
                    <template #default="scope">
                        <span>{{ scope.row.status == 1 ? '未收藏' : '已收藏' }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="训练时间" align="center" prop="createTime">
                    <template #default="scope">
                        <span>{{ scope.row.createTime }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="备注内容" align="center" prop="remake">
                    <template #default="scope">
                        <span>备注内容</span>
                    </template>
                </el-table-column>
...
.el-input__prefix /deep/ .el-input__icon{
    color: #fff !important;
}
.selectBox{
    height: 36px;
