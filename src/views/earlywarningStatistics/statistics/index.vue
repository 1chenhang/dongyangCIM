  ...
  <div class="warpper">
    ...
    <div class="tableWrapper">
      <el-table ref="reportTable" height="500" class="table-with-header-bg" :data="landList" stripe
        ...
        <el-table-column label="预警信息" prop="alarmDescribe" />
        ...
        <el-table-column label="地块名称" prop="dkmc" align="center"/>
        ...
        <el-table-column label="操作">
          <template #default="scope">
            ...
            <el-button link type="primary" size="small" @click="exportToWord(scope.row)">
              生成报告
            </el-button>
          </template>
        </el-table-column>
...
const exportToWord = async (row) => {
  const imageUrls = getUrl(row);
  const base64Strings = await Promise.all(imageUrls.map(imageObj => getBase64FromUrl(imageObj.url)));
  const imageHtml = base64Strings.map(base64String => `
      <tr height="50" style="height:55pt;">
          <td colspan="4" class="et2" height="300" x:str="" style="">
              <img src="${base64String}" width="600" height="300" />
          </td>
      </tr>
  `).join('');
          ...
          <tbody>
              <tr height="50" style="height:31.95pt;" class="firstRow">
                  <td colspan="4" class="et2" height="55" x:str="" style="">
                      <span class="font2">预警报告</span>
                  </td>
              </tr>
              <tr height="50" style="height:55pt;">
                  <td class="et2" height="55" x:str="" style="">
                      <span class="font2">预警时间</span>
                  </td>
                  <td class="et2" width="140" x:str="" style="">
                      <span class="font2">${row.alarmTime ? row.alarmTime : '暂无数据'}</span>
                  </td>
                  <td class="et2" x:str="" style="">
                      <span class="font2">取证类型</span>
                  </td>
                  <td class="et2" x:str="" style="">
                      <span class="font2">自动</span>
                  </td>
              </tr>
              <tr height="50" style="height:55pt;">
                  ...
                  <td class="et2" x:str="" style="">
                      <span class="font2">${row.townName}</span>
                  </td>
                  <td class="et2" width="140" x:str="" style="">
                      <span class="font2">摄像头名称</span>
                  </td>
                  <td class="et2" x:str="" style="">
                      <span class="font2">${row.deviceName}</span>
                  </td>
              </tr>
              <tr height="50" style="height:55pt;">
                  <td class="et2" height="55" x:str="" style="">
                  ...
                  <td class="et2" width="140" x:str="" style="">
                      <span class="font2">${row.dkmc || '暂无'}</span>
                  </td>
                  <td class="et2" x:str="" style="">
                      <span class="font2">地块类型</span>
                  </td>
                  <td class="et2" width="140" x:str="" style="">
                      <span class="font2">${row.landType || '暂无'}</span>
                  </td>
              </tr>
              <tr height="50" style="height:55pt;">
                  <td class="et2" height="55" x:str="" style="">
                  ...
                  <td class="et2" x:str="" style="">
                      <span class="font2">${row.alarmTypeName || '暂无'}</span>
                  </td>
                  <td class="et2" x:str="" style="">
                      <span class="font2">预警种类</span>
                  </td>
                  <td class="et2" x:str="" style="">
                      <span class="font2">${row.alarmOtherTypeName || '暂无'}</span>
                  </td>
              </tr>
              <tr height="50" style="height:55pt;">
                  <td class="et2" height="55" x:str="" style="">
                  ...
                  <td colspan="3" class="et2" x:str="" style="">
                      <span class="font2">${row.alertPlotLon}，${row.alertPlotLat}</span>
                  </td>
              </tr>
              <tr height="50" style="height:55pt;">
                  <td class="et2" height="55" x:str="" style="">
                  ...
                  <td colspan="3" class="et2" x:str="" style="">
                      <span class="font2">水平角度:${row.pan} 俯仰角度:${row.tilt} 放大倍数:${row.zoom}</span>
                  </td>
              </tr>
              <tr height="50" style="height:55pt;">
                  <td colspan="4" class="et2" height="55" x:str="" style="">
                      <span class="font2">预警照片</span>
                  </td>
              </tr>
        ${imageHtml}
          </tbody>
  ...
  link.download = '预警报告.docx'
  document.body.appendChild(link)
  link.click()
  document.body.removeChild(link)
  //if (videoSrc.value) downloadMP4(videoSrc.value, '预警视频')
}
